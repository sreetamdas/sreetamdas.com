...
More recently, I've worked extensively with Python and the Google Cloud Platform, and been responsible for rewrites of a flagship, future-ready products at my company. I work with a stack of React, Redux, and TypeScript. I am also a firm believer in developer tooling, and a couple of packages I install for just about every project can be found [here](/tooling)
