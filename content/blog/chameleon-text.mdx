...
<ChameleonHighlight>
{/* prettier-ignore */}
  <a href="#" className="visited:no-underline hover:underline hover:decoration-current hover:decoration-solid focus-visible:outline-dashed focus-visible:outline-8 focus-visible:outline-secondary text-[clamp(4rem,10vw,7rem)]">Look, a link!</a>
</ChameleonHighlight>
