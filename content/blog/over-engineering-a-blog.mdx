...
In the process of making a more complete specification of the tooling that I wanted to include in my project, I ended up with a spin-off: [sreetamdas/stack](https://github.com/sreetamdas/stack), a modern-day-tech stack boilerplate for `React + TypeScript + Styled Components` projects.
