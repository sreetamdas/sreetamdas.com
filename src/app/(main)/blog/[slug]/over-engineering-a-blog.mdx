...
description: "Building this website with Next.js, TypeScript and Styled-components"
published: true
...
One of my goals with the rewrite of my website was that I wanted to be able to play around with it. This meant being able to use third-party packages; and TypeScript allows your [IDE](/uses) to use types from respective packages with VS Code's IntelliSense.

In the process of making a more complete specification of the tooling that I wanted to include in my project, I ended up with a spin-off: [<Gradient>**sreetamdas/stack**</Gradient>](https://github.com/sreetamdas/stack), a modern-day-tech stack boilerplate for `React + TypeScript + Styled Components` projects.
