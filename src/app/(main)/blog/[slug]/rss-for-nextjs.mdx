...
seo_title: "How to add an RSS Feed in a Next.js site"
description: "RSS feeds are a great way for people to notify their readers that they've published new content! Here's how to add an RSS feed for a Next.js site"
published: true
