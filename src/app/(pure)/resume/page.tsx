					...
					<div id="main">
						<div id="experience">
							...
							<p className="mb-2 mt-4">
								...
								<span className="italic">
									Senior Frontend Engineer II, <span className="uppercase">Dec 2023 - present</span>
								</span>
							</p>
							...
							<p className="mb-2 mt-4">
								<span className="italic">
									Senior Frontend Engineer I, <span className="uppercase">Dec 2021 - Dec 2023</span>
								</span>
							</p>
							...
							<ul className="list-outside list-disc pl-4">
								...
								<li>
									...
									Ahrefs, VWO, DataDog, etc. and working with Google Tag Manager, Prismic, HubSpot,
									Mailgun and Litmus
								</li>
							...
							<ul className="list-outside list-disc pl-4">
								<li>
									Module Lead for UI development: Rewrote codebase with React, Redux and TypeScript,
									as well as Websockets, Styled components and Jest
								</li>
								<li>
						...
						<div id="projects">
							...
							<ul className="mt-4 list-outside list-disc pl-4">
								<li>
									<a className="link-base">sreetamdas.com</a>: personal website built with Next.js,
									TypeScript and friends; open-sourced
								</li>
								<li>
								...
								<li>
									<a className="link-base">Greenscreen</a>: using HTML Canvas API, also presented at
									a conference
								</li>
								<li>
									<a className="link-base">Karma</a>: a colourful VS Code theme with 18000+ installs
								</li>
								<li>
