import { CustomBlockquote, Highlight } from "styles/blog";
import { StyledAccentTextLink } from "styles/typography";
...
![gif showing MDXJS' website flicker before toggling dark mode on refresh](/blog/the-perfect-dark-mode/perfect-dark-mode-mdxjs-flicker.gif)
...
```jsx filename=pages/index.js {16,29,44}
import { useState } from "react";
...
![gif showing blocking nature of <script> tags in HTML](/blog/the-perfect-dark-mode/perfect-dark-mode-blocking-script.gif)

<CustomBlockquote>
  If you'd like to try it out for yourself, check out this{" "}
  <a href="https://codesandbox.io/s/sleepy-cartwright-ufhxs?file=/index.html">
    sandbox
  </a>
</CustomBlockquote>
...
CSS variables really shine when you want to have to reuse certain values in your CSS; my website uses a few that you can see [here](https://github.com/sreetamdas/sreetamdas.com/blob/master/pages/_app.tsx)
...
```jsx {36,40} filename=pages/_document.js
import Document, {
  Html,
  Head,
  Main,
...
```jsx filename=pages/index.js {4,37}
...
<CustomBlockquote type="success">
  If you're using{" "}
  <a href="https://styled-components.com">Styled-components</a>, then
  this isn't an issue since we can use <code>ServerStyleSheet()</code>{" "}
  which makes sure that the CSS being imported in <code>App</code> is
  correctly collected and added to the <code>Document</code> itself,
  thus preventing the flicker during development as well
  <br />
  <br />
  <a href="https://styled-components.com/docs/advanced#nextjs">
    Refer the docs
  </a> or check out <a href="https://github.com/sreetamdas/sreetamdas.com/blob/master/pages/_document.tsx#L10">my implementation</a>
</CustomBlockquote>
...
We've got the perfect dark mode, one without any flickering. As [Josh mentioned](https://joshwcomeau.com/gatsby/dark-mode) this was certainly not an easy task; I definitely didn't expect to work with things like CSS variables and IIFEs and I'm certain you didn't either!
...
Repository: <a href="https://github.com/sreetamdas/nextjs-perfect-dark-mode-example">github.com/sreetamdas/nextjs-perfect-dark-mode-example</a>

Sandbox: <a href="https://codesandbox.io/s/dreamy-nightingale-ikwks?file=/pages/_document.js">codesandbox.io/s/dreamy-nightingale-ikwks</a>

</CustomBlockquote>

Of course, there are [packages which can handle all of this for you](https://github.com/donavon/use-dark-mode#that-flash) including "the flash" which differ only slightly in their implementation (Donavon here uses the `.class` method)
