...
export const customMDXComponents: MDXComponents = {
	...
	h2: ({ children, ...props }: HTMLAttributes<HTMLHeadingElement>) => (
		<Heading.h2
			className="group pt-10 font-serif text-4xl leading-normal font-bold text-primary"
			{...props}
		>
			{children}
		</Heading.h2>
	...
	h3: ({ children, ...props }: HTMLAttributes<HTMLHeadingElement>) => (
		<Heading.h3
			className="group pt-10 font-serif text-2xl leading-normal font-bold text-primary"
			{...props}
		>
			{children}
		</Heading.h3>
