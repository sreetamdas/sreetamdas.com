...
import { type StatsCounterProps } from "./StatsCounter";
import {
...
type StatsCounterViewProps = StatsCounterProps & {
...
export const StatsCounterView = (props: StatsCounterViewProps) => {
...
const StatsCounterContent = ({
	page_type = "page",
	hidden = false,
	disabled,
	variant = "engagement",
	normalizedPathname,
}: StatsCounterViewProps) => {
