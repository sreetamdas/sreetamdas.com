...
// The bubble is centred on its trigger, and this stat sits at the end of the
// stats row, so on narrow viewports half of a 16rem bubble is wider than the
// gap to the right edge and pushes `main` into horizontal overflow. Cap the
// width below `sm` where the room runs out; wider screens keep the full 16rem.
