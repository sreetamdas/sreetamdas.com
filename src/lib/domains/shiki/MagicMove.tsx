...
export const MagicMove = (props: MagicMoveProps) => {
	...
	return (
		<figure className="relative my-10">
			<div className="sticky top-[60px] z-10 -mx-4 flex justify-between gap-2 bg-background py-1 max-sm:px-2 sm:-mr-5 sm:-ml-12 sm:pr-5 sm:pl-12">
				<button
			...
			<div className="my-2 flex flex-col">
				<div className="-mx-4 grid grid-flow-col overflow-x-scroll rounded-tl-global rounded-tr-global bg-karma-background pr-2 pl-2 sm:-mr-5 sm:-ml-12 sm:pr-5 sm:pl-12">
					{file_name ? (
				...
				{highlighter && (
					<ShikiMagicMove
						...
						options={options}
						className="-mx-4 overflow-x-scroll rounded-br-global rounded-bl-global p-5 text-xs max-sm:px-2 sm:-mr-5 sm:-ml-12 sm:text-sm [&>.shiki-magic-move-line-number]:mr-2 [&>.shiki-magic-move-line-number]:w-6 [&>.shiki-magic-move-line-number]:pr-2 [&>.shiki-magic-move-line-number]:text-right [&>.shiki-magic-move-line-number]:whitespace-nowrap max-sm:[&>.shiki-magic-move-line-number]:hidden"
					/>
				)}
			</div>
		</figure>
