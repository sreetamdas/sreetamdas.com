...
import { BASE_FONT_SIZE, focusVisible, sharedTransition } from "@/lib/styles/helpers";
import { interFont, iosevkaFont } from "@/lib/typography";
...
export const GlobalStyles = createGlobalStyle`
	...
	--values-secondary-accent: 53, 142, 241;
